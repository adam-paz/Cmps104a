...
int main (int argc, char** argv) {
   ...
   *dot_pos = '\0';
   ...
   strcpy(outname_oil, basename(filename));
   auto dp = strrchr(outname_oil, '.');
   *dp = '\0';
   strcat(outname_oil, ".oil");
   outfile_oil = fopen(outname_oil, "w");


   print_sym_tables(yyparse_astree, 0);
   //make_sym_tables(yyparse_astree);
